...
from AAISPT.Traj_cls.AdapTransformer.train_val import train_model
...
# Set parameters
num_tasks = 2
feature_dims = [32, 46]  # Feature dimensions for each task
...
train_X_lists_scaled = scaler.transform(train_X_lists[0], task_id=0)
val_X_lists_scaled = scaler.transform(val_X_lists[0], task_id=0)
...
history = {
    'total_train_losses': History['total_train_losses'],
