...
from AAISPT.Benchmark.Cls_Adap_Transformer.dataset import TrajectoryScaler, VariableLengthDataset, collate_fn
from AAISPT.Benchmark.Cls_Adap_Transformer.model import MultiTaskTransformer
from AAISPT.Benchmark.Cls_Adap_Transformer.train_val import test_model

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# Set parameters
task_id = 0  # This value is determined by the order of the input and output of the training dataset across all tasks.
feature_dims = [32]
num_classes_list = [5]
batch_size = 2048
