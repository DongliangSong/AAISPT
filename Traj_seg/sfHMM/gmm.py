...
class GMMs:
    ...
    The best Models can be chosen by comparing AIC or BIC.
    """    
    ...
    def fit(self, n_init:int=1, random_state:int=0, scale:float=1.0, **kwargs):
        """
        Fit data to k-state Models, for every k in self.klist. Peak intervals and
    ...
    def get_optimal(self, criterion:str="bic", only_valid:bool=True):
        """
        Determine the best Models that minimize AIC or BIC.
